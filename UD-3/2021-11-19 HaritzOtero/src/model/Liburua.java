...
public class Liburua {
    ...
    public void setGaia(String gaia) {
        ...
        if (gaia.toUpperCase().equals("FIKZIOA")) {
            this.gaia = "Fikzioa";
        } else if (gaia.toUpperCase().equals("HISTORIKOA")) {
    ...
    public static ArrayList<Liburua> getLiburuSortaArrayList() {
        
        ArrayList<Liburua> alLiburuak = new ArrayList<Liburua>();
        
        alLiburuak.add(new Liburua("El bosque oscuro", "Cixin Liu", 408, 2008, "FIKZIOA", 'g', 12.95));
        alLiburuak.add(new Liburua("The Hobbit", "J.R.R. Tolkien", 413, 1937, "fikzioa", 'i', 20.95));
        alLiburuak.add(new Liburua("The Lord of the Rings", "J.R.R. Tolkien", 122, 1954, "FIkziOA", 'I', 15.95));
        alLiburuak.add(new Liburua("Matxinsaltoen belarriak", "Unai Elorriaga", 122, 2006, "?", 'E', 10.95));
        alLiburuak.add(new Liburua("Las brujas", "Roald Dahl", 222, 1983, "Fikzioa", 'G', 10.95));
        alLiburuak.add(new Liburua("Boy", "Roald Dahl", 122, 1984, "HISTORIKOA", 'I', 5.95));
        alLiburuak.add(new Liburua("Obabakoak", "Bernardo Atxaga", 392, 1988, "FIKZIOA", 'E', 22.50));
